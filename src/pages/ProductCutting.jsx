            ...
            <section className="w-10/12 mx-auto text-center py-16 px-6">
                <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
                    <div className="bg-white mx-auto rounded-xl shadow-md shadow-cyan-800/40 p-4 hover:scale-105 duration-500 text-cyan-800 border border-cyan-500/20">
                        ...
                        />
                        <h3 className="text-lg font-semibold">Motif Cutting 1</h3>
                    </div>
                    <div className="bg-white mx-auto rounded-xl shadow-md shadow-cyan-800/40 p-4 hover:scale-105 duration-500 text-cyan-800 border border-cyan-500/20">
                        <img
                            src="/img/motif2.png"
                            ...
                            className="rounded mb-3"
                        />
                        <h3 className="text-lg font-semibold">Motif Cutting 2</h3>
                    </div>
                    <div className="bg-white mx-auto rounded-xl shadow-md shadow-cyan-800/40 p-4 hover:scale-105 duration-500 text-cyan-800 border border-cyan-500/20">
                        <img
                            src="/img/motif3.png"
                            ...
                            className="rounded mb-3"
                        />
                        <h3 className="text-lg font-semibold">Motif Cutting 3</h3>
                    </div>
                    <div className="bg-white mx-auto rounded-xl shadow-md shadow-cyan-800/40 p-4 hover:scale-105 duration-500 text-cyan-800 border border-cyan-500/20">
                        <img
                            src="/img/motif4.png"
                            ...
                            className="rounded mb-3"
                        />
                        <h3 className="text-lg font-semibold">Motif Cutting 4</h3>
                    </div>
                    <div className="bg-white mx-auto rounded-xl shadow-md shadow-cyan-800/40 p-4 hover:scale-105 duration-500 text-cyan-800 border border-cyan-500/20">
                        <img
                            src="/img/motif5.png"
                            ...
                            className="rounded mb-3"
                        />
                        <h3 className="text-lg font-semibold">Motif Cutting 5</h3>
                    </div>
                </div>
            </section>
        </div>
